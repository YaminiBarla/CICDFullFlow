...
public class ecomersePageObjModel_HashMap extends invokeBrowser{
	...
	public Object[][] getData() {
		...
		map.put("Email", "yamini@gmail.com");
		map.put("Password", "$Bynsunanda$410");
		map.put("ProductName", "ZARA COAT 3");
		
		
		HashMap<String,String> map1 = new HashMap<String,String>();
		map1.put("Email", "pranavi@gmail.com");
		map1.put("Password", "$Pranavi$410");
